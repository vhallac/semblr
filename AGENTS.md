...
The extension lives at `src/semblr.ts` (~1926 lines, moved from `.pi/extensions/semblr.ts` to avoid pi auto-loading). It:
...
- `src/semblr.ts` — the extension (single file, ~1926 lines)
